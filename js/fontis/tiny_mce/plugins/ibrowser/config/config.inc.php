<?php
    ...
    // Absolute path to user files
    //$magentoBase = Mage::getBaseDir();
    ...
    if(!is_dir(Mage::getBaseDir()."/$uploadPath/"))
    {
        $userFilesPath = null;
    }
    else
...
/*		array (
    ...
    {
        $cfg['ilibs_dir'] = array($userFilesPath);						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
    }
